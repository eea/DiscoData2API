...
namespace DiscoData2API.Controllers
{
      ...
      public class QueryController : ControllerBase
      {
            ...
            [HttpGet("CreateQuery")]
            public async Task<ActionResult<MongoDocument>> CreateQuery()
            {
                  return null;
                  // return await _mongoService.GetAllAsync();
            }
            ...
            [HttpGet("ReadQuery")]
            public async Task<ActionResult<MongoDocument>> ReadQuery()
            {
                  return null;
                  // return await _mongoService.GetAllAsync();
            }
            ...
            [HttpGet("UpdateQuery")]
            public async Task<ActionResult<MongoDocument>> UpdateQuery()
            {
                  return null;
                  // return await _mongoService.GetAllAsync();
            }
            ...
            public async Task<ActionResult<MongoDocument>> DeleteQuery()
            {
                  return null;
                  // return await _mongoService.GetAllAsync();
            }

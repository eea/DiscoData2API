...
namespace DiscoData2API_Priv.Services
{
    public class ParameterSubstitutionService
    {
        ...
        public string SubstituteParameters(string query, List<ViewParameter>? viewParameters, Dictionary<string, string>? providedParameters)
        {
            ...
            foreach (Match match in matches)
            {
                ...
                {
                    parameterValue = providedParameters[parameterName];
                }
